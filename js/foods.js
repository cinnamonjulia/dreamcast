...
/* the boring-but-essential things everyone forgets to list
   (the first 20 ids are load-bearing — recipes & saved ticks reference them) */
export const STAPLES = [
  ...
  { id: 'acv', name: 'apple cider vinegar' },
  { id: 'rice-vinegar', name: 'rice vinegar' },
  { id: 'red-wine-vinegar', name: 'red wine vinegar' },
  ...
  { id: 'curry-paste', name: 'curry paste' },
  { id: 'salsa', name: 'salsa' },
  { id: 'pesto', name: 'pesto' },
  { id: 'pasta-sauce', name: 'pasta / marinara sauce' },
  { id: 'tomato-paste', name: 'tomato paste' },
  { id: 'tahini', name: 'tahini' },
  { id: 'ranch', name: 'ranch' },
  { id: 'salad-dressing', name: 'salad dressing' },
  ...
  { id: 'choc-chips', name: 'chocolate chips' },
  { id: 'condensed-milk', name: 'sweetened condensed milk' },
  { id: 'evaporated-milk', name: 'evaporated milk' },
  { id: 'sprinkles', name: 'sprinkles' },
  // grains, pasta & dry goods
  { id: 'rice', name: 'rice' },
  { id: 'pasta', name: 'pasta' },
  { id: 'noodles', name: 'noodles / ramen' },
  ...
  { id: 'popcorn', name: 'popcorn kernels' },
  // canned & jarred
  { id: 'canned-tomatoes', name: 'canned tomatoes' },
  { id: 'black-beans', name: 'canned black beans' },
  { id: 'chickpeas', name: 'chickpeas' },
  { id: 'canned-beans', name: 'other canned beans' },
  { id: 'canned-tuna', name: 'canned tuna' },
  { id: 'canned-corn', name: 'canned corn' },
  { id: 'canned-soup', name: 'canned soup' },
  { id: 'coconut-milk', name: 'canned coconut milk' },
  { id: 'peanut-butter', name: 'peanut butter' },
  { id: 'jam', name: 'jam / jelly' },
  ...
  { id: 'chia-flax', name: 'chia / flax seeds' },
  { id: 'raisins', name: 'raisins' },
  { id: 'dried-cranberries', name: 'dried cranberries' },
  // keep-forever produce & drinks
  { id: 'onions', name: 'onions' },
  { id: 'potatoes', name: 'potatoes' },
  { id: 'coffee', name: 'coffee' },
  { id: 'tea', name: 'tea' },
  { id: 'cocoa-mix', name: 'hot cocoa mix' },
];
